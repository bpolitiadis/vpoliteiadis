...
import { n as renderJSX, o as createVNode, p as AstroJSX, q as AstroUserError } from './chunks/astro/server_DSPR3m_Y.mjs';
import 'clsx';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  if (children && opts.experimentalReactChildren) {
    ...
    const convert = await import('./chunks/vnode-children_CSvTydPA.mjs').then((mod) => mod.default);
...
const renderers = [Object.assign({"name":"@astrojs/react","clientEntrypoint":"@astrojs/react/client.js","serverEntrypoint":"@astrojs/react/server.js"}, { ssr: server_default$1 }),Object.assign({"name":"astro:jsx","serverEntrypoint":"file:///Users/vpoliteiadis/workspace/vpoliteiadis/node_modules/.pnpm/@astrojs+mdx@4.3.3_astro@5.12.8_@types+node@24.1.0_jiti@1.21.7_rollup@4.46.2_terser@5.43.1_typescript@5.9.2_yaml@2.8.0_/node_modules/@astrojs/mdx/dist/server.js"}, { ssr: server_default }),];
