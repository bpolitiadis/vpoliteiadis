import { e as commonjsGlobal, g as getDefaultExportFromCjs } from '../../chunks/astro/server_oRAxjIhj.mjs';
import require$$0$6 from 'node:os';
...
function requireThreadStream () {
	...
	const { pathToFileURL } = require$$0$3;
