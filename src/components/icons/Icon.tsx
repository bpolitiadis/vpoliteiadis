...
export const GalleryIcon = (props: Omit<IconProps, 'name'>) => <Icon name="gallery" {...props} />;
...
export const GraduationIcon = (props: Omit<IconProps, 'name'>) => <Icon name="graduation" {...props} />;
